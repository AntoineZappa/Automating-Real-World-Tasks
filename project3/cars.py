...
import locale
import sys
from reports import generate as report_gen
from emails import generate as email_gen
...
def main(argv):
    ...
    report_gen('/tmp/cars.pdf', "Cars report",
               new_summary, cars_dict_to_table(data))
    # TODO: send the PDF report as an email attachment
    msg = email_gen("automation@example.com", "student-02-37f15fc4f065@example.com",
